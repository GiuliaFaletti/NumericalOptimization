...
print("Initial Total Luminosity=", L_tot_2017_2Par, "ub^-1")
...
ax1.set_ylabel('Normalized Frequencies')
ax1.set_title('2017')
ax1.plot([],[], "k.", label="Initial L_tot={:.2f} fb^-1".format(L_tot_2017_2Par/1e9))
...
#comparison between real and optimized integrated luminosity
fig, ax1= plt.subplots()
ax1.hist(L_int_2017_2Par/1e9,  facecolor='steelblue', density=True, alpha=0.5, label="Real Integrated Luminosities" )

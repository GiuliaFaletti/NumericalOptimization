...
with open('Data/res_2018_4Par_2Fill.txt', 'w') as fz:
        fz.write('')
        fz.close()
...
for k in combination_2:
    ...
    tot=sum(x0)+ts_tot_18[k[0]]+ta[k[0]]+ts_tot_18[k[1]]+ta[k[1]]
    ...
    for el in res.x:
        with open('Data/res_2018_4Par_2Fill.txt', 'a') as fz:
            fz.write(str(el))
            fz.write('\n')
    ...
    ax1.set_title('2018')
    plt.legend(loc='best')
    plt.savefig('Test2_18_4Par/2018_4Par_{}.pdf'.format(k))
    ...
    ax1.set_title('2018')
    plt.savefig('Test2_18_4Par/2018_4Par_ratio_{}.pdf'.format(k))
    ...
    plt.savefig('Test2_18_4Par/2018_4Par_lumi_{}.pdf'.format(k))
    ...
    ax1.set_ylabel(r'Normalized Frequencies')
    ax1.set_title('2018')
    plt.savefig('Test2_18_4Par/2018_4Par_istLumi_{}.pdf'.format(k))
...
plt.legend(loc='best')
plt.savefig('Test2_18_4Par/2018_4Par_Test.pdf')


with open('Data/L_tot_2018_4Par_Measured_Real_2Fills.txt', 'w') as f:
        f.write('')
        f.close()
for el in L_tot_test:
    with open('Data/L_tot_2018_4Par_Measured_Real_2Fills.txt', 'a') as f:
        f.write(str(el))
        f.write('\n')
        
        
with open('Data/L_tot_evaluated_2018_4Par_Measured_Real_2Fill.txt', 'w') as f:
        f.write('')

...
print("Initial Total Luminosity=", L_tot_2016_4Par, "ub^-1")
...
fig, ax1= plt.subplots()
ax1.hist(L_int_2016_4Par/1e9,  facecolor='steelblue', density=True, alpha=0.4, label="Real Integrated Luminosities" )
...
ax1.set_ylabel('Normalized Frequencies')
ax1.set_title('2016')
ax1.plot([],[], "k.", label="Initial L_tot={:.2f} fb^-1".format(L_tot_2016_4Par/1e9))

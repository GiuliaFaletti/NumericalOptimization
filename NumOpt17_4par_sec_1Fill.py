...
for k in range(len(ts_tot_17)):
    ...
    print("Initial Total Luminosity=", L_tot_2017, "ub^-1")
    ...
    ax1.set_ylabel('Normalized Frequencies')
    ax1.set_title('2017')
    ax1.plot([],[], "k.", label="Initial L_tot={:.2f} fb^-1".format(L_tot_2017/1e9))
...
ax1.axvline(np.average(L_tot_tot_2017/1e9), color='b', linestyle='dashed', linewidth=1, label="Real L_tot={:.2f} fb^-1".format(L_tot_tot_2017/1e9))

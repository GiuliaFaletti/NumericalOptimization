...
ax1.set_ylabel('Normalized Frequencies')
ax1.set_title('2018')
ax1.plot([],[], "k.", label="Initial L_tot={:.2f} fb^-1".format(L_tot_2018_2Par/1e9))
...
#comparison between real and optimized integrated luminosity
fig, ax1= plt.subplots()
ax1.hist(L_int_2018_2Par/1e9,  facecolor="pink", alpha=0.8, density=True,  label="Real Integrated Luminosities" )

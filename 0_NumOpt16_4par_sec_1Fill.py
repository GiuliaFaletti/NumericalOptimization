...
with open('Data/res_2016_4Par_1Fill.txt', 'w') as fz:
        fz.write('')
        fz.close()
...
for k in range(len(ts_tot_16)):
    ...
    ax1.set_title('2016')
    plt.savefig('Test_16_4Par/2016_4Par_ratio_{}.pdf'.format(k))
    
    with open('Data/t_opt/t_opt_2016_1Fill_{}.txt'.format(k), 'w') as f:
        f.write('')
        f.close()
    for el in res.x:
        with open('Data/t_opt/t_opt_2016_1Fill_{}.txt'.format(k), 'a') as f:
            f.write(str(el))
            f.write('\n')

    for el in res.x:
        with open('Data/res_2016_4Par_1Fill.txt', 'a') as fz:
            fz.write(str(el))
            fz.write('\n')
    ...
    with open('Data/L_opt/L_opt_2016_1Fill_{}.txt'.format(k), 'w') as f:
        f.write('')
        f.close()
    for el in L_int_opt:
        with open('Data/L_opt/L_opt_2016_1Fill_{}.txt'.format(k), 'a') as f:
            f.write(str(el))
            f.write('\n')
    ...
    with open('Data/L_ist_opt/L_ist_opt_2016_1Fill_{}.txt'.format(k), 'w') as f:
        f.write('')
        f.close()
    for el in L_int_opt:
        with open('Data/L_ist_opt/L_ist_opt_2016_1Fill_{}.txt'.format(k), 'a') as f:
            f.write(str(el))
            f.write('\n')
...
with open('Data/L_tot_2016_4Par_Measured_Real_1Fill.txt', 'w') as f:
        f.write('')
        f.close()
for el in L_tot_test:
    with open('Data/L_tot_2016_4Par_Measured_Real_1Fill.txt', 'a') as f:
        f.write(str(el))
        f.write('\n')
        
        
with open('Data/L_tot_evaluated_2016_4Par_Measured_Real_1Fill.txt', 'w') as f:
        f.write('')

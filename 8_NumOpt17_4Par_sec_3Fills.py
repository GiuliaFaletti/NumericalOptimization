...
with open('Data/res_2017_4Par_3Fill.txt', 'w') as fz:
        fz.write('')
        fz.close()
...
for k in combination_3:
    ...
    tot=sum(x0)+ts_tot_17[k[0]]+ta[k[0]]+ts_tot_17[k[1]]+ta[k[1]]+ts_tot_17[k[2]]+ta[k[2]]
    ...
    for el in res.x:
        with open('Data/res_2017_4Par_3Fill.txt', 'a') as fz:
            fz.write(str(el))
            fz.write('\n')
    ...
    ax1.set_title('2017')
    plt.legend(loc='best')
    plt.savefig('Test3_17_4Par/2017_4Par_{}.pdf'.format(k))
    ...
    ax1.set_title('2017')
    plt.savefig('Test3_17_4Par/2017_4Par_ratio_{}.pdf'.format(k))
    ...
    plt.savefig('Test3_17_4Par/2017_4Par_lumi_{}.pdf'.format(k))
    """
    def fun2(t1):
        result=np.empty(len(x0))
        for i in range(len(x0)):
    ...
    ax1.set_ylabel(r'Normalized Frequencies')
    ax1.set_title('2017')
    plt.savefig('Test3_17_4Par/2017_4Par_istLumi_{}.pdf'.format(k))
    """
...
plt.legend(loc='best')
plt.savefig('Test3_17_4Par/2017_4Par_Test.pdf')




with open('Data/L_tot_2017_4Par_Measured_Real_3Fills.txt', 'w') as f:
        f.write('')
        f.close()
for el in L_tot_test:
    with open('Data/L_tot_2017_4Par_Measured_Real_3Fills.txt', 'a') as f:
        f.write(str(el))
        f.write('\n')
